...
resource "aws_instance" "PublicEC2" {
  ...
  user_data = <<-EOF
                ...
                EOF
  depends_on = [
    aws_vpc.mainvpc,aws_subnet.PublicSubnets,aws_security_group.ec2_public_security_group
  ]
}
...
resource "aws_instance" "PrivateEC2" {
  ...
  user_data = <<-EOF
                ...
                EOF
  depends_on = [
    aws_vpc.mainvpc,aws_subnet.PublicSubnets,aws_security_group.ec2_private_security_group
  ]
}
